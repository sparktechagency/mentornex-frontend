...
const NeedHelpSection = () => {
      return (
            <div className=" md:flex container h-[310px] mb-10 w-full relative justify-between bg-gradient-image py-16 px-8 text-white  rounded-xl shadow-lg">
                  ...
                  <div className="md:absolute right-5 bottom-0">
